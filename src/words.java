...
//    Default constructor
    ...
    //This method generates a random word based on the difficulty selected by the user (The length of the word they selected)
    ...
    */
    ...
    // Selects difficulty (picks the length of the word)
